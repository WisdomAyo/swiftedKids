                ...
                <div class="col-lg-4">
                    <div class="widget footer-widget">
                        <div class="widget-about">
                            ...
                            <p class="map-link"><img src="assets/img/icon/map.svg" alt="svg">First Floor, 10A Chandos Street London New Town W1G 9LE</p>
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="row flex-row-reverse gy-3 justify-content-between align-items-center">
                ...
                <div class="col-lg-auto">
                    <p class="copyright-text ">Copyright &copy; 2023 <a href="index.html">SwiftEgde </a>. All Rights Reserved By <a href="https://themeforest.net/user/vecuro_themes">Vecuro</a></p>
                </div>
            </div>
        </div>
    </div>
