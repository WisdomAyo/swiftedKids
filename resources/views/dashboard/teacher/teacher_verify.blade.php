...
<section class="position-relative  bg-dark  ">
		...
		<div class="row g-4 align-items-center">
			<div class="col-md-6 position-relative">
				...
				<div class="d-flex align-items-center mb-4">
					<div class="icon-md rounded-circle shadow fs-5 text-warning">
						<i class="bi bi-lightbulb"></i>
					</div>
					<span class="h6 ms-3 mb-0 text-light">Verify now and Grow With Us</span>
				</div>

				<!-- Title -->
				<h1 class="mb-4 display-6 text-light ">We Just Sent You
					<span class="position-relative z-index-3">A Mail
						<!-- SVG START -->
						<span class="position-absolute top-50 start-50 translate-middle z-index-1 mt-n2 d-none d-sm-block">
							<svg class="fill-warning" width="357px" height="84.1px" viewBox="0 0 357 84.1" style="enable-background:new 0 0 357 84.1;" xml:space="preserve">
				...
				<p class="mb-4 lead">You will receive a mail to complete your profile, kindly follow the link </p>

				<!-- Button -->
				<div class="d-lg-flex mb-4">
					<a href="#" class="btn btn-primary me-4">SwiftKids<i class="bi bi-arrow-right ms-2"></i></a>
					<a href="#" class="btn btn-light"><i class="fas fa-photo-video me-2"></i> View Other Tutors<i class="bi bi-arrow-right ms-2"></i></a>
				</div>
				...
				<div class="d-sm-flex align-items-center">
					...
					<!-- Content -->
					<p class="mb-0 h6 ms-0 ms-sm-3">Trusted by over 15K Users Worldwide Since 2022</p>
				</div>
			</div>

			<!-- Image -->
			<div class="col-md-6">
				<img src="{{asset('assets/dashboard/images/08.png')}}" alt="">
			</div>
		</div>
	</div>
    ...
    <p class="bottom text-dark" >sgds</p>
    <p class="bottom text-dark" >sgds</p>
    <p class="bottom text-dark" >sgds</p>
    <p class="bottom text-dark" >sgds</p>
    <p class="bottom text-dark" >sgds</p>
